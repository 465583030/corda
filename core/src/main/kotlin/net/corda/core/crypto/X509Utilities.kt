...
object X509Utilities {
     ...
     */
    private fun getCertificateValidityWindow(before: Duration, after: Duration, parent: X509CertificateHolder? = null): Pair<Date, Date> {
    ...
    fun createKeystoreForCordaNode(sslKeyStorePath: Path,
        ...
        clientCAKeystore.addOrReplaceKey(
                ...
                clientKey.private,
                keyPass,
                listOf(clientCACert, intermediateCACert, rootCACert).mapToArray(converter::getCertificate))
        ...
        tlsKeystore.addOrReplaceKey(
                ...
                tlsKey.private,
                keyPass,
                listOf(clientTLSCert, clientCACert, intermediateCACert, rootCACert).mapToArray(converter::getCertificate))
