...
class FlowFrameworkTests {
    ...
    fun `unsupported new flow version`() {
        node2.registerFlowFactory(UpgradedFlow::class.java, InitiatedFlowFactory.CorDapp(version = 1, factory = ::DoubleInlinedSubFlow))
        ...
        noinline flowFactory: (Party) -> P): ListenableFuture<P>
    {
        val firstInitiatedFlow = smm.changes
            ...
            .map { it.logic as P }
            .toFuture()
        registerFlowFactory(initiatingFlowClass.java, object : InitiatedFlowFactory {
